      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>Ugx. <?php echo  $result->PRODISPRICE ?></td>
                          <td>Ugx. <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                    <div> Total Price :   Ugx. <span id="sum">0.00</span></div>
                    <div> Delivery Fee : Ugx. <span id="fee">0.00</span></div>
                    <div> Overall Price : Ugx. <span id="overall"><?php echo $tot ;?></span></div>
 ...
 <section id="do_action">
    <div class="container">
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio">
                      <label>
                          <input type="radio" class="paymethod" name="paymethod" id="deliveryfee" value="Cash on Delivery" checked="true" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Mobile Money 
                                    ...
                                    <div class="form-group ">
                                      <label>Address where to deliver</label>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <label class="col-md-1 control-label" for=
                                          "RECEIVER">Person to receive:</label>

                                          <div class="col-md-3">
                                           
                                          <input type="text" placeholder="RECEIVER" id="RECEIVER" name="RECEIVER" value="" class="form-control" required />
                                          </div>
                                          ...
                                          <textarea cols="6" name="COMMENT" class="form-control"></textarea>
                                          </div>
      ...
      <div class="heading">
        ...
        <p style="display: none;">Choose if you have a discount code or reward points you want to use or would like to estimate your delivery cost.</p>
      </div>
              <br/>
              <div class="row">
                <div class="col-md-6">
