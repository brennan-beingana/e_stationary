	...
	<div class="modal-header">
		...
		<table>
			<tr>
				...
				<img src="<?php echo web_root; ?>images/home/logos/logo4.jpg" alt="Image">
        </td> 
			</tr>
		</table>
...
?>
 	 <h4>Your order has been <span style="color: green;"> confirmed</span></h4><br/>
 		<h5>DEAR Madam/Sir ,</h5>
		<h5>Your order is on its way! As you have ordered via Cash on Delivery, please have the exact amount of cash for our deliverer.	</h5>
		 ...
		 <div class="row">
		 	...
		 	<div class="col-md-6">
		 	<p>Customer Name : <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></p>
		 	<!-- <p>Address : <?php echo $cur->ADDRESS;?></p> -->
		 		<!-- <p>Contact Number : <?php echo $cur->CONTACTNUMBER;?></p> -->
		 	<p>Receiver : <?php echo $cur->RECEIVER;?></p>
		 	</div>
		 </div>
<?php 
}elseif ($cur->PAYMENTMETHOD=="Mobile Money"){
		 
?>
 	 <h4>Your order has been <span style="color: green;"> confirmed</span></h4><br/>
 		<h5>DEAR Madam/Sir ,</h5>
		<h5>Your order is on its way! As you have ordered via Mobile Money, please note that no extra money will be charged on delivery by our deliverer.	</h5>
		 <hr/>
		 <h4><strong>Delivery Information</strong></h4>
		 <div class="row">
		 	<div class="col-md-6">
...
<hr/>
 <h4><strong>Order Information</strong></h4>
				 ...
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> Ugx. '. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> Ugx. <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
		...
		if ($cur->PAYMENTMETHOD=="Cash on Delivery" || $cur->PAYMENTMETHOD=="Mobile Money") {
			# code...
			$price = $cur->DELFEE;
		}else{
			$price = 0.00;
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : Ugx. <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : Ugx. <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : Ugx. <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
