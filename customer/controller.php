...
function doInsert(){
	...
	function doDelete(){
		...
		//	$_SESSION['ORDEREDNUM'] = $_POST['ORDEREDNUM'];
			...
			$CUSID = (isset($_SESSION['CUSID']) && $_SESSION['CUSID'] != '') ? $_SESSION['CUSID'] : 0;
			...
			$summary->HVIEW 		= 0	;
			$summary->RECEIVER		= $_POST['RECEIVER'];
			$summary->COMMENT		= $_POST['COMMENT'];
			$summary->USERID		= $CUSID;
			$summary->create();
		  }
