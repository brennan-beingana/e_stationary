                                     ...
                                     <div class="panel-body">
                                        ...
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+256 000000000" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="EMAILADD" name="EMAILADD" placeholder= "email" type="text" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Statiofy.</small>
