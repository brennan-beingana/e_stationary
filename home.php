          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>STATIOFY</span></h1>
                  <h2>Order Now</h2>
                  <p>Imagine walking up every morning feeling refreshed and energized. Our new e-stationary is designed to provide ultimate confort and support, ensuring a restful night's sleep. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/girl1.jpg" class="girl img-responsive" alt="" />
                  <img src="images/home/image_tag2.png"  class="pricing" alt="" />
                </div>
              </div>
              <div class="item">
                <div class="col-sm-6">
                  ...
                  <p>Stop spending hours on looking for scholastic materials. Let us get you covered, so you can focus on what matters most. </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>STATIOFY</span></h1>
                  <h2>Free Delivery</h2>
                  <p>Get your product delivered to the specified location at zero cost. </p>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Stock Items</h2>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>Ugx. <?php echo $result->PRODISPRICE; ?></h2>
                      <h4 style="text-decoration: line-through; color: maroon;">Ugx. <?php echo $result->ORIGINALPRICE; ?></h4>
                    ...
                    <div class="product-overlay">
                      ...
                      <img src="<?php echo web_root.'admin/products/'. $result->IMAGES; ?>" alt="" style="width: 100%; height: 100%; transition: transform 0.5s ease; object-fit: cover;"/>
                        <h2>Ugx. <?php echo $result->PRODISPRICE; ?></h2>
                        <p><?php  echo $result->PRODESC; ?></p>
                       <button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                      </div>
