  ...
  <?php check_message(); ?>
      <div class="">
        <div class="panel panel-default">
          ...
          <div>Every products has a mininum price of Ugx. 50.00 each to be able to order.</div>
      <div class="table-responsive">
       <div  class="fixnmix_scroll_carttwo" >
         ...
         <tbody > 
            ...
            ?>
                      <tr>
                        ...
                        <td>Ugx. <?php echo number_format($result->PRICE,2) ?></td>
                        ...
                        <td>Ugx. <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price'] ; ?></output>
        ...
        ?>
                  ...
                  <table  >
                  <tfoot >
                     <strong><h1 align="right">Total Price : Ugx. <span style="margin-right:3%"  id="sum">0.00</span></h1></strong></td>
                    ...
                    <div class="tab-content"> 
                      ...
                      <form action="login.php"  onsubmit="return validatepasswords()"  method="post">
                          <div class="modal-body">
                              ...
                              <p align="left">&copy; E-Stationary Ordering System</p>
               ...
               ?> 
                ...
                <div class="panel-head" style="margin-left:3%"><h3>address</h3></div>
                 ...
                 <!--  <div class="form-group">
                  ...
                  <div class="modal-footer"><p align="left">&copy; E-Stationary Ordering System</p>
                    <button class="btn btn-default" data-dismiss="modal" type=
                    "button">Close</button> 
