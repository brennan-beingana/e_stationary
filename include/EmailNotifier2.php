...
class EmailNotifier2 {
    ...
    public function sendEmails2($message=0) {
        ...
        foreach ($recipients as $recipient) {
            ...
            try {
                ...
                $this->mailer->Subject = 'Statiofy: New Promotion!';
                $this->mailer->Body = "Hi <b>{$recipient['FNAME']}</b>,<br>{$message}";
    ...
    private function getRecipients() {
        $stmt = $this->pdo->query("SELECT * FROM tblcustomer");
