...
<title>E-Stationary | <?php echo $title;?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php">Statiofy</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                       ...
                       <!--   <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/clients/index.php" ><i class="fa fa-user fa-fw"></i>  Customers </a>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/promotions/index.php" ><i class="fa fa-envelope fa-fw"></i>  Promotions </a>
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; <?php echo date('Y') ?> All Rights Reserved </p></footer>
</html>