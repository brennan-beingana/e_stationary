...
<div class="modal-content">
	...
	<div class="row" style="margin:2%">
		<div class="col-md-6">Ordered By : <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></div>
		<div class="col-md-6">Address:  <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . ' ' .$cur->BRGYADD . ' ' . $cur->CITYADD . ' ' .$cur->PROVINCE . ' ' .$cur->COUNTRY; ?>
     </div>
	</div>
	<div class="row" style="margin:2%">
		<div class="col-md-6">Receiver : <?php echo $cur->RECEIVER ;?></div>
		<div class="col-md-6">School:  <?php echo $cur->COMMENT; ?>
     </div>
	</div>
		 
	<form action="controller.php?action=photos&id=<?php echo $cur->CUSTOMERID; ?>" enctype="multipart/form-data" method=
	"post">
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		...
		  		<p align="right">Delivery Fee : Ugx. <?php echo number_format($cur->DELFEE,2); ?></p>
