...
function doInsert(){
	...
	function doEdit(){
		...
		if ($_GET['actions']=='confirm') {
			...
			//$notifier = new EmailNotifier('localhost', 'db_name', 'root', '');
			$notifier = new EmailNotifier();
			$notifier->sendEmails($_GET['id']);
...
VALUES (NULL, '".$cur->PHONE."', 'Statiofy', 'Your order has been ".$status.". The amount is ".$cur->PAYMENT."')";
			...
			foreach ($cur as $result) {
	  		 ...
	  		 $sql = "INSERT INTO `messageout` (`Id`, `MessageTo`, `MessageFrom`, `MessageText`) 
VALUES (NULL, '".$result->OWNERPHONE."', 'Statiofy', 'Your product has been ordered. The amount is ".$result->PAYMENT."')";
