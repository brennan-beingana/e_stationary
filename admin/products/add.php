              ...
              <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "Owner Name" type="text" value="E-STATIONARY">
                      </div>
                    </div>
                  </div>  
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "+256 0000000000" type="text" value="+256 744870987">
                      </div>
                    </div>
                  </div> 
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-3">
                         <input class="form-control input-sm" id="ORIGINALPRICE" name="ORIGINALPRICE" placeholder=
                            "Ugx. Original Price" type="number" value=""  step="any">
                      </div>
