<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">List of School  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
			  ...
			  <tbody>
				  	<?php 
						...
						foreach ($cur as $result) { 
				  		...
				  		echo '<td> Ugx. '.  number_format($result->DELPRICE,2).'</td>'; 
				  		echo
				  		 '<td align="left">
